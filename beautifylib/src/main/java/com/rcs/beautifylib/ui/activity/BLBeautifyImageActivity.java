...
import com.rcs.beautifylib.adapter.Filter_Effect_Adapter;
import com.rcs.beautifylib.adapter.Filter_Sticker_Adapter;
import com.rcs.beautifylib.adapter.FragmentViewPagerAdapter;
import com.rcs.beautifylib.model.BLBeautifyParam;
import com.rcs.beautifylib.model.BLEnhanceParam;
import com.rcs.beautifylib.model.BLMosaicParam;
import com.rcs.beautifylib.model.BLResultParam;
import com.rcs.beautifylib.model.BLScrawlParam;
import com.rcs.beautifylib.model.BLStickerInfo;
import com.rcs.beautifylib.model.Filter_Effect_Info;
import com.rcs.beautifylib.tag.DIRECTION;
import com.rcs.beautifylib.tag.TagViewGroup;
import com.rcs.beautifylib.tag.model.TagGroupModel;
import com.rcs.beautifylib.tag.views.ITagView;
import com.rcs.beautifylib.tag.views.TagEditDialog;
import com.rcs.beautifylib.ui.activity.base.BLToolBarActivity;
import com.rcs.beautifylib.ui.fragment.BLBeautifyFragment;
import com.rcs.beautifylib.utils.BLConfigManager;
import com.rcs.beautifylib.utils.BLStickerUtils;
import com.rcs.beautifylib.utils.FilterUtils;
import com.rcs.beautifylib.view.CustomViewPager;
...
import static com.rcs.beautifylib.R.id.effect_listview;
import static com.rcs.beautifylib.R.id.txt_graffiti;
...
public class BLBeautifyImageActivity extends BLToolBarActivity implements View.OnClickListener {
    ...
    private enum FUN_TYPE {FILTER, STICKER, TAG, CROP, SCRAWL, EDIT, MOSAIC}
...
//                CropImageView.SOURCE_IMAGE_ASPECT_RATIO, CropImageView.SOURCE_IMAGE_ASPECT_RATIO), new AspectRatio(null, 3, 4), new AspectRatio(null, 6, 7));
    ...
    private void onScrawlClick() {
        BLScrawlParam.mBitmap = getCurrentFragment().getBitmap();
...
//        setSelectedTxt(FUN_TYPE.EDIT);
        BLEnhanceParam.mBitmap = getCurrentFragment().getBitmap();
...
//                    mModelList.add(group);
    ...
    private void onMosaicClick() {
        BLMosaicParam.mBitmap = getCurrentFragment().getBitmap();
        BLMosaicParam.startActivity(mInstance, new BLMosaicParam());
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == UCrop.REQUEST_CROP) {
            ...
            getCurrentFragment().setBitmap(BLEnhanceParam.mBitmap);
        } else if (requestCode == BLScrawlParam.REQUEST_CODE_SCRAWL) {
            getCurrentFragment().setBitmap(BLScrawlParam.mBitmap);
        } else if(requestCode == BLMosaicParam.REQUEST_CODE_MOSAIC){
            getCurrentFragment().setBitmap(BLMosaicParam.mBitmap);
        }
    }
